...
<head>
    ...
    <title>KODIM 0624 | Kabupaten Bandung</title>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                                <ul class="nav navbar-nav navbar-right">
                                    ...
                                    <li><a href="service.html">Pejabat</a></li>
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                            aria-haspopup="true" aria-expanded="false">Berita <span
                                                class="ion-ios-arrow-down"></span></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                                            aria-haspopup="true" aria-expanded="false">Giat <span
                                                class="ion-ios-arrow-down"></span></a>
                                        <ul class="dropdown-menu">
                                    ...
                                    <li><a href="https://themefisher.com/free-bootstrap-templates/" target="_blank"
                                            class="btn">Admin</a></li>
                                </ul>
                            </div><!-- /.navbar-collapse -->
                        </div><!-- /.container-fluid -->
                    </nav>
    ...
    <section class="slider">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="block">
                        <h1 class="animated fadeInUp">KODIM 0624 <br>Kabupaten Bandung</h1>
                        <p class="animated fadeInUp">We love the Web and the work we do.We work closely with our
                            clients to deliver </br> the best possible solutions for their needs</p>
                ...
                <div class="col-md-7 col-sm-12">
                    <div class="block">
                        <div class="section-title">
                            <h2>Profile Kodim 0624 Kab.Bandung</h2>
                        ...
                        <a href="https://themefisher.com/free-bootstrap-templates/" target="_blank"
                            class="btn btn-main animated fadeInUp">Lihat Detail</a>
                    </div>
                </div><!-- .col-md-7 close -->
            ...
            <div class="row ">
                <div class="col-sm-6 col-md-3">
                    <div class="service-item">
                        <img src="images/zda.jpg" alt="Pepole">
                        <h4>Jendral TNI Agus</h4>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut
                        </p>
                    </div>
                </div>
